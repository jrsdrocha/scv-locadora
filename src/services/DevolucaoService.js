...
class DevolucaoService {
    ...
    static async findByPk(req) {
        ...
        const obj = await Devolucao.findOne({ where: { eprestimoId: emprestimoId, fitaId: fitaId } });
        return obj;
    }
    ...
    static async create(req) {
        ...
        if (item == null) throw "Não foi encontrado item de empréstimo para associá-lo a devolução!"
    ...
    static async update(req) {
        ...
        if (obj == nul) throw "Multa não encontrada!"
    ...
    static async delete(req) {
        const { emprestimoId, fitaId } = req.params;
        const obj = await Devolucao.findOne({ where: { emprestimoId: emprestimoId, fitaId: fitaId } });
        if (obj == null) throw "Multa nao encontrada!"
        await obj.destroy();
        return obj;
    }
